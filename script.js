...
const products = {
    lps: [
        ...
        { id: 3, name: 'Conejo #12', image: 'images/lps-03.jpg', description: 'Conejito adorable y suave' },
        { id: 4, name: 'Hámster #7', image: 'images/lps-04.jpg', description: 'Pequeño y energético' },
        { id: 5, name: 'Pájaro Azul #3', image: 'images/lps-05.jpg', description: 'Ave colorida y cantarina' },
        { id: 6, name: 'Tortuga #8', image: 'images/lps-06.jpg', description: 'Lenta y sabia' },
        { id: 7, name: 'Gatito Blanco #15', image: 'images/lps-07.jpg', description: 'Gato tierno y mimoso' },
        { id: 8, name: 'Perro Pequeño #22', image: 'images/lps-08.jpg', description: 'Compañero fiel' },
        { id: 9, name: 'Pato #11', image: 'images/lps-09.jpg', description: 'Pato acuático' },
        { id: 10, name: 'Gato Negro #19', image: 'images/lps-10.jpg', description: 'Misterioso y elegante' },
        { id: 11, name: 'Poni Rosa #24', image: 'images/lps-11.jpg', description: 'Equino mágico' },
        { id: 12, name: 'Gato Naranja #31', image: 'images/lps-12.jpg', description: 'Gato cálido y brillante' },
        { id: 13, name: 'Bulldog Francés #14', image: 'images/lps-13.jpg', description: 'Perro robusto y cariñoso' },
        { id: 14, name: 'Conejo Gris #28', image: 'images/lps-14.jpg', description: 'Conejo suave y tranquilo' },
        { id: 15, name: 'Loro Rojo #9', image: 'images/lps-15.jpg', description: 'Loro parlanchín' },
        { id: 16, name: 'Erizo #16', image: 'images/lps-16.jpg', description: 'Pequeño y espinoso' },
        { id: 17, name: 'Mariposa #20', image: 'images/lps-17.jpg', description: 'Insecto delicado y colorido' },
        { id: 18, name: 'Ratón #4', image: 'images/lps-18.jpg', description: 'Roedorcito adorable' },
        { id: 19, name: 'Gallo #26', image: 'images/lps-19.jpg', description: 'Ave de granja' },
        { id: 20, name: 'Oveja #13', image: 'images/lps-20.jpg', description: 'Oveja lanuda' },
        { id: 21, name: 'Canguro #30', image: 'images/lps-21.jpg', description: 'Saltador australiano' },
        { id: 22, name: 'Leopardo #6', image: 'images/lps-22.jpg', description: 'Felino salvaje' },
        { id: 23, name: 'Mono #18', image: 'images/lps-23.jpg', description: 'Primate juguetón' },
        { id: 24, name: 'Oso #25', image: 'images/lps-24.jpg', description: 'Oso grande y fuerte' },
        { id: 25, name: 'Panda #10', image: 'images/lps-25.jpg', description: 'Oso tierno chino' },
        { id: 26, name: 'Koala #21', image: 'images/lps-26.jpg', description: 'Marsupial soñador' },
        { id: 27, name: 'Elefante #2', image: 'images/lps-27.jpg', description: 'Gigante inteligente' },
